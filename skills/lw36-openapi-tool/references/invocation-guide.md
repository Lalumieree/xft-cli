...
- Local SDK behavior used for exact request construction:
  [XftOpenApiReqClient.java](/Users/nateshen/Documents/xft-tool/LW36.20_Jar_New_Java/src/main/java/com/cmb/xft/open/api/XftOpenApiReqClient.java)
  [XftVerifyTokenClient.java](/Users/nateshen/Documents/xft-tool/LW36.20_Jar_New_Java/src/main/java/com/cmb/xft/open/api/XftVerifyTokenClient.java)
  [XftVerifySignClient.java](/Users/nateshen/Documents/xft-tool/LW36.20_Jar_New_Java/src/main/java/com/cmb/xft/open/api/XftVerifySignClient.java)

## What could be confirmed

- 薪福通开放平台官方站点可访问，文档入口位于 `xft.cmbchina.com/open/`。
- 该文档页是前端单页应用路由，当前抓取环境拿不到 `id=10692` 这页的正文 HTML。
- 因此下面的调用规则是依据官方站点入口加本地 LW36 Java SDK源码整理出来的，属于基于官方 SDK 的实现性归纳。
